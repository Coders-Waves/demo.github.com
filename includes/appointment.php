...
$mail->Username = 'thenervasoft@gmail.com';                 // SMTP username
$mail->Password = 'Nervasoft@112233';                           // SMTP password
...
if( $_SERVER['REQUEST_METHOD'] == 'POST' ) {
    if( $_POST['form_name'] != '' AND $_POST['form_email'] != '' ) {
        ...
        $toemail = 'mdkha2010@gmail.com'; // Your Email Address
        $toname = 'Nervasoft HMS'; // Your Name
